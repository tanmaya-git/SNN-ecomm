...
<html>
  <head>
    ...
    <title>My JSP 'EUSearchResult.jsp' starting page</title>
		...
		<center>
			...
			<div style="width: 1000px; height: auto; margin-top: -15px;">
				...
				<div style="margin-top: -3px;"><jsp:include
						page="EcommUserMenu.jsp"></jsp:include></div>
				<div class="signup"
...
<hr/>
					...
					<div style="width: 950px; height: auto; background-color: white; float: inherit;">
						...
						<div style="width: 300px; height: auto; float: left;">
							...
							<br />
							<br />
							<a href="EUSearchResultProductBuy.jsp?key=<%=i%>"><img src="images/buynow.PNG" width="120px;"
