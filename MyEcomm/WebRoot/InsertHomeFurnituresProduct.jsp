...
<html>
  <head>
    ...
    <title>My JSP 'InsertHomeFurnituresProduct.jsp' starting page</title>
				...
				<div class="signup" style="margin-top: -1px; width: 100%;">
					<center>
						...
						<div style="">
							<br />
							<h2>
								Insert new Home Furnitures product
							</h2>
							<br />
							...
							<input type="hidden" name="category" value="HomeFurnitures">
								...
								<table>
									...
									<tr>
										...
										<td>										
											<select name="subCategory" id="cat5">
												<option value="">
													---Select---
												</option>
