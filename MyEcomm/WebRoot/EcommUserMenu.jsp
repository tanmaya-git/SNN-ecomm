...
<html>
  <head>
    ...
    <title>My JSP 'EcommUserMenu.jsp' starting page</title>
...
<script src="css/HoverMenu.js" type="text/javascript"></script>
  ...
  <body>   
 		 ...
 		 <ul id="nav">
 		 			<li class="top">
 					 <a href="EcommUserHome.jsp" class="top_link"><span>User Home</span> </a>						
					</li>
					<li class="top">
 					 <a href="Search.jsp" class="top_link"><span>SearchProduct</span> </a>						
					</li>
					
					
					<li class="top">
 					 <a href="EcommUserExrecommendation.jsp" class="top_link"><span>Existing recommendations</span> </a>						
					</li>
					<!-- 
